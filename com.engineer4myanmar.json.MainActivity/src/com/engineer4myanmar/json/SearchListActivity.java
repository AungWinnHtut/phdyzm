...
//called by Search2Activity with parameter HashMap
...
public class SearchListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Toast.makeText(getApplicationContext(), input_range,
		// Toast.LENGTH_SHORT).show();
		// Toast.makeText(getApplicationContext(), input_rating,
		// Toast.LENGTH_SHORT).show();
		// Toast.makeText(getApplicationContext(), input_cuisine,
		// Toast.LENGTH_SHORT).show();
		// Toast.makeText(getApplicationContext(), input_min,
		// Toast.LENGTH_SHORT).show();
		// Toast.makeText(getApplicationContext(), input_max,
		// Toast.LENGTH_SHORT).show();
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String infoname = ((TextView) view.findViewById(R.id.info_name))
						.getText().toString();
				// Toast.makeText(getApplicationContext(),infoname,
				// Toast.LENGTH_SHORT).show();
	...
	private class HttpAsyncTaskSearch extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... urls) {
			...
			params1.add(new BasicNameValuePair("x0", x0));
			params1.add(new BasicNameValuePair("y0", y0));
			params1.add(new BasicNameValuePair("r", r));
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							...
							R.layout.list_item, new String[] { "info_name",
									"address", "phone_no" },
							new int[] { R.id.info_name, R.id.address,
									R.id.phone_no });
					// updating listview
